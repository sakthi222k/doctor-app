...
export default function SignUp(){
    ...
    return (
      <Paper elevation={12} className="LoginPage">
        <p style={{ color: "#b5b0b0" }}>
          Hi there welcome too <span style={{ color: "blue" }}>Shedula</span>
        </p>
        <h3>Login</h3>
        ...
        <div className="loginsetup">
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <span style={{ color: "#b5b0b0" }}>Remember Me</span>
          </div>
        ...
        <div className="noaccount">
          <p style={{ color: "#b5b0b0" }}>Don&apos;t have an account?</p>
          <p style={{ color: "blue", fontSize: "14px" }}>Sign Up</p>
        </div>
      </Paper>
    );
}